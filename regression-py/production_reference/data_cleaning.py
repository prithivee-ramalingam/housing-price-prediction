...
def clean_product_table(context, params):
    ...
    so on.
    """
    print("Inside clean product table")
    ...
    print("completed clean product table")
...
def clean_order_table(context, params):
    ...
    """
    print("inside clean order table")
    ...
    print("completed clean order table")
...
def clean_sales_table(context, params):
    ...
    """
    print("Inside clean sales table")
    ...
    print("Completed clean sales table")
...
def create_training_datasets(context, params):
    ...
    print("started create training datasets")
    ...
    print("completed create training datasets")
