...
print("TESTS_FOLDER", TESTS_FOLDER)
print("CONDA_ENV_FOLDER", CONDA_ENV_FOLDER)
print("PIP_REQ_FOLDER", PIP_REQ_FOLDER)
print("PYSPARK_ENV_FOLDER", PYSPARK_ENV_FOLDER)
print("NOTEBOOK_FOLDER", NOTEBOOK_FOLDER)
...
def calculate_complexity(c, path="production"):
    """
    ...
    c : invoke.context.Context
        The context instance (passed automatically by invoke).
    path : str, optional
        The path to the codebase to analyze, by default the current directory.
    """
    ...
    print(f"Calculating complexity score for the codebase at {path}")
    c.run(f"radon cc {path} -s")
